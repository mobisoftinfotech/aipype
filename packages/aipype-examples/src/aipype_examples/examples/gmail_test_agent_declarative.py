"""Gmail Test Agent - Declarative syntax version using @task decorators.

This agent demonstrates the new declarative syntax for the aipype framework,
...
def main() -> None:
    ...
    try:
        ...
        agent = GmailTestAgentDeclarative("gmail_test_agent", config)
        results = agent.run()
